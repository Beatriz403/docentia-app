...
export default function BotonEmergencia() {
  ...
  const handleDownloadWord = async () => {
      ...
      sections: [{
        ...
        children: [
          new Paragraph({
            ...
            children: [new TextRun({ text: "Actividad de Emergencia - DocentIA", bold: true })],
            spacing: { after: 200 }
          }),
          new Paragraph({
            children: [
              new TextRun({ text: `Nivel: `, bold: true }),
              new TextRun(formData.nivel),
            ],
            spacing: { after: 50 }
          }),
          new Paragraph({
          ...
          new Paragraph({
            children: [
              ...
              new TextRun(formData.asignatura),
            ],
            spacing: { after: 50 }
          }),
          new Paragraph({
            children: [
              ...
              new TextRun(`${formData.duracion} minutos`),
            ],
            spacing: { after: 300 }
          }),
          ...paragraphs
    ...
    saveAs(blob, "actividad-emergencia.docx")
  }
