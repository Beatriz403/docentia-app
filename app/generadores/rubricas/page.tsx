...
import { Loader2, ClipboardCheck, Download, Plus, RotateCcw } from "lucide-react"
...
export default function RubricasPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${API_URL}/generar/rubrica`, {
        method: "POST",
        headers: {
      ...
      setResultado("Error al generar la rúbrica. Por favor, intenta de nuevo.")
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleDownload = () => {
    if (resultado) {
      ...
      a.href = url
      a.download = `rubrica-${Date.now()}.txt`
      a.click()
      ...
      <main className="container mx-auto px-6 py-12 lg:py-20">
        ...
        <div className="text-center mb-12 space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Crea rúbricas profesionales con niveles de logro y descriptores claros
          </p>
        ...
        {!resultado && !loading && (
          <Card className="max-w-3xl mx-auto">
            <CardHeader>
              <CardTitle>📊 Datos de la rúbrica</CardTitle>
              <CardDescription>
                Define la actividad para generar una rúbrica completa
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label>Actividad o tarea a evaluar *</Label>
                  <Input
                    placeholder="Ej: Proyecto sobre el ciclo del agua, Presentación oral sobre la Edad Media..."
                ...
                <div className="space-y-2">
                  <Label>Niveles de logro *</Label>
                  <Select
                    value={formData.niveles_logro.toString()}
                    onValueChange={(value) => setFormData({ ...formData, niveles_logro: parseInt(value) })}
                    required
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      <SelectItem value="3">3 niveles (Insuficiente, Suficiente, Excelente)</SelectItem>
                      <SelectItem value="4">4 niveles (Insuficiente, Suficiente, Notable, Sobresaliente)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="flex gap-4 pt-4">
                  <Button
                    type="submit"
                    className="flex-1 bg-gradient-to-br from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white"
                    size="lg"
                  >
        ...
        {loading && (
          <Card className="max-w-3xl mx-auto">
            <CardContent className="py-12 text-center">
              ...
              <h3 className="text-2xl font-bold mb-2">📊 Generando rúbrica profesional...</h3>
              <p className="text-muted-foreground mb-4">Claude está creando criterios y descriptores detallados</p>
              <p className="text-sm text-muted-foreground">
                ✍️ Definiendo criterios... 📐 Creando descriptores... ✨ Aplicando LOMLOE...
              </p>
            </CardContent>
          </Card>
        )}
        ...
        {resultado && !loading && (
          <Card className="max-w-3xl mx-auto">
            <CardHeader>
              ...
              <CardDescription>Tu rúbrica está lista para usar en evaluación</CardDescription>
            </CardHeader>
